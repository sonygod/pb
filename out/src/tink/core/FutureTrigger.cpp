...
HX_LOCAL_STACK_FRAME(_hx_pos_057f1a2129988235_364_asFuture,"tink.core.FutureTrigger","asFuture",0x48bf6f01,"tink.core.FutureTrigger.asFuture","tink/core/Future.hx",364,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_057f1a2129988235_384_trigger,"tink.core.FutureTrigger","trigger",0xd946328c,"tink.core.FutureTrigger.trigger","tink/core/Future.hx",384,0x014a8a08)
...
::Dynamic FutureTrigger_obj::asFuture(){
            	HX_STACKFRAME(&_hx_pos_057f1a2129988235_364_asFuture)
HXDLIN( 364)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
bool FutureTrigger_obj::trigger( ::Dynamic result){
            	HX_STACKFRAME(&_hx_pos_057f1a2129988235_384_trigger)
HXDLIN( 384)		if (hx::IsNull( this->list )) {
HXDLIN( 384)			return false;
            		}
            		else {
HXLINE( 386)			::Array< ::Dynamic> list = this->list;
HXLINE( 387)			this->list = null();
HXLINE( 388)			this->result = result;
HXLINE( 389)			::tink::core::_Callback::CallbackList_Impl__obj::invoke(list,result);
HXLINE( 390)			::tink::core::_Callback::CallbackList_Impl__obj::clear(list);
