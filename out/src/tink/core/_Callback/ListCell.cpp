...
HX_LOCAL_STACK_FRAME(_hx_pos_b8a55a11cc272be0_134_invoke,"tink.core._Callback.ListCell","invoke",0x7e1047e9,"tink.core._Callback.ListCell.invoke","tink/core/Callback.hx",134,0x0104eb06)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b8a55a11cc272be0_143_cancel,"tink.core._Callback.ListCell","cancel",0x9663bdeb,"tink.core._Callback.ListCell.cancel","tink/core/Callback.hx",143,0x0104eb06)
namespace tink{
namespace core{
namespace _Callback{
...
void ListCell_obj::invoke( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_b8a55a11cc272be0_134_invoke)
HXDLIN( 134)		if (hx::IsNotNull( this->cb )) {
HXLINE( 135)			::tink::core::_Callback::Callback_Impl__obj::invoke(this->cb,data);
            		}
            	}
...
void ListCell_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_b8a55a11cc272be0_143_cancel)
HXDLIN( 143)		::Array< ::Dynamic> _g = this->list;
HXLINE( 144)		if (hx::IsNotNull( _g )) {
HXLINE( 145)			::Array< ::Dynamic> v = _g;
HXDLIN( 145)			{
HXLINE( 145)				this->clear();
HXDLIN( 145)				v->remove(hx::ObjectPtr<OBJ_>(this));
            			}
            		}
            	}
