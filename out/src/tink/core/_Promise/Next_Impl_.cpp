...
HX_LOCAL_STACK_FRAME(_hx_pos_e94dd746376366a6_315_ofSafe,"tink.core._Promise.Next_Impl_","ofSafe",0x55933a60,"tink.core._Promise.Next_Impl_.ofSafe","tink/core/Promise.hx",315,0x59ef4bb6)
HX_LOCAL_STACK_FRAME(_hx_pos_e94dd746376366a6_318_ofSync,"tink.core._Promise.Next_Impl_","ofSync",0x55a5776e,"tink.core._Promise.Next_Impl_.ofSync","tink/core/Promise.hx",318,0x59ef4bb6)
HX_LOCAL_STACK_FRAME(_hx_pos_e94dd746376366a6_321_ofSafeSync,"tink.core._Promise.Next_Impl_","ofSafeSync",0xd668d0db,"tink.core._Promise.Next_Impl_.ofSafeSync","tink/core/Promise.hx",321,0x59ef4bb6)
HX_LOCAL_STACK_FRAME(_hx_pos_e94dd746376366a6_324__chain,"tink.core._Promise.Next_Impl_","_chain",0x438b349e,"tink.core._Promise.Next_Impl_._chain","tink/core/Promise.hx",324,0x59ef4bb6)
namespace tink{
namespace core{
namespace _Promise{
...
bool Next_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x19301fc0;
}
 ...
 ::Dynamic Next_Impl__obj::ofSafe( ::Dynamic f){
            		...
            		::Dynamic _hx_run( ::Dynamic x){
            			HX_GC_STACKFRAME(&_hx_pos_e94dd746376366a6_315_ofSafe)
HXDLIN( 315)			return  ::tink::core::_Future::SyncFuture_obj::__alloc( HX_CTX , ::tink::core::_Lazy::LazyConst_obj::__alloc( HX_CTX ,f(x)));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_e94dd746376366a6_315_ofSafe)
HXDLIN( 315)		return  ::Dynamic(new _hx_Closure_0(f));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Next_Impl__obj,ofSafe,return )
 ...
 ::Dynamic Next_Impl__obj::ofSync( ::Dynamic f){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f) HXARGC(1)
            		::Dynamic _hx_run( ::Dynamic x){
            			HX_STACKFRAME(&_hx_pos_e94dd746376366a6_318_ofSync)
HXDLIN( 318)			::Dynamic ret = ::tink::core::_Future::FutureObject_obj::map(f(x),::tink::core::Outcome_obj::Success_dyn());
HXDLIN( 318)			return ::tink::core::_Future::FutureObject_obj::gather(ret);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_e94dd746376366a6_318_ofSync)
HXDLIN( 318)		return  ::Dynamic(new _hx_Closure_0(f));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Next_Impl__obj,ofSync,return )
 ...
 ::Dynamic Next_Impl__obj::ofSafeSync( ::Dynamic f){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f) HXARGC(1)
            		::Dynamic _hx_run( ::Dynamic x){
            			HX_GC_STACKFRAME(&_hx_pos_e94dd746376366a6_321_ofSafeSync)
HXDLIN( 321)			return  ::tink::core::_Future::SyncFuture_obj::__alloc( HX_CTX , ::tink::core::_Lazy::LazyConst_obj::__alloc( HX_CTX ,::tink::core::Outcome_obj::Success(f(x))));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_e94dd746376366a6_321_ofSafeSync)
HXDLIN( 321)		return  ::Dynamic(new _hx_Closure_0(f));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Next_Impl__obj,ofSafeSync,return )
 ...
 ::Dynamic Next_Impl__obj::_chain( ::Dynamic a, ::Dynamic b){
            		...
            		::Dynamic _hx_run( ::Dynamic v){
            			HX_STACKFRAME(&_hx_pos_e94dd746376366a6_324__chain)
HXDLIN( 324)			::Dynamic _hx_tmp = a(v);
HXDLIN( 324)			return ::tink::core::_Promise::Promise_Impl__obj::next(_hx_tmp,b,null());
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_e94dd746376366a6_324__chain)
HXDLIN( 324)		return  ::Dynamic(new _hx_Closure_0(a,b));
            	}
