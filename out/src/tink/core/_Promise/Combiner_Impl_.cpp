...
HX_LOCAL_STACK_FRAME(_hx_pos_6fd4e598c3617773_338_ofSafe,"tink.core._Promise.Combiner_Impl_","ofSafe",0xbff3cac0,"tink.core._Promise.Combiner_Impl_.ofSafe","tink/core/Promise.hx",338,0x59ef4bb6)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6fd4e598c3617773_344_ofSafeSync,"tink.core._Promise.Combiner_Impl_","ofSafeSync",0xeac9113b,"tink.core._Promise.Combiner_Impl_.ofSafeSync","tink/core/Promise.hx",344,0x59ef4bb6)
namespace tink{
namespace core{
namespace _Promise{
...
bool Combiner_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x140784c4;
}
 ...
 ::Dynamic Combiner_Impl__obj::ofSafe( ::Dynamic f){
            		...
            		::Dynamic _hx_run( ::Dynamic x1, ::Dynamic x2){
            			HX_GC_STACKFRAME(&_hx_pos_6fd4e598c3617773_338_ofSafe)
HXDLIN( 338)			return  ::tink::core::_Future::SyncFuture_obj::__alloc( HX_CTX , ::tink::core::_Lazy::LazyConst_obj::__alloc( HX_CTX ,f(x1,x2)));
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_STACKFRAME(&_hx_pos_6fd4e598c3617773_338_ofSafe)
HXDLIN( 338)		return  ::Dynamic(new _hx_Closure_0(f));
            	}
...
HXDLIN( 341)			::Dynamic ret = ::tink::core::_Future::FutureObject_obj::map(f(x1,x2),::tink::core::Outcome_obj::Success_dyn());
HXDLIN( 341)			return ::tink::core::_Future::FutureObject_obj::gather(ret);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Combiner_Impl__obj,ofSync,return )
 ...
 ::Dynamic Combiner_Impl__obj::ofSafeSync( ::Dynamic f){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f) HXARGC(2)
            		::Dynamic _hx_run( ::Dynamic x1, ::Dynamic x2){
            			HX_GC_STACKFRAME(&_hx_pos_6fd4e598c3617773_344_ofSafeSync)
HXDLIN( 344)			return  ::tink::core::_Future::SyncFuture_obj::__alloc( HX_CTX , ::tink::core::_Lazy::LazyConst_obj::__alloc( HX_CTX ,::tink::core::Outcome_obj::Success(f(x1,x2))));
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_STACKFRAME(&_hx_pos_6fd4e598c3617773_344_ofSafeSync)
