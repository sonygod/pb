...
HX_DEFINE_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_51_new,"tink.core._Lazy.LazyFunc","new",0x6759c9f8,"tink.core._Lazy.LazyFunc.new","tink/core/Lazy.hx",51,0x92445137)
HX_LOCAL_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_53_get,"tink.core._Lazy.LazyFunc","get",0x67547a2e,"tink.core._Lazy.LazyFunc.get","tink/core/Lazy.hx",53,0x92445137)
HX_LOCAL_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_65_map,"tink.core._Lazy.LazyFunc","map",0x67590434,"tink.core._Lazy.LazyFunc.map","tink/core/Lazy.hx",65,0x92445137)
HX_LOCAL_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_64_map,"tink.core._Lazy.LazyFunc","map",0x67590434,"tink.core._Lazy.LazyFunc.map","tink/core/Lazy.hx",64,0x92445137)
HX_LOCAL_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_68_flatMap,"tink.core._Lazy.LazyFunc","flatMap",0xffbcb5fb,"tink.core._Lazy.LazyFunc.flatMap","tink/core/Lazy.hx",68,0x92445137)
HX_LOCAL_STACK_FRAME(_hx_pos_abecf4c8a88f2d81_67_flatMap,"tink.core._Lazy.LazyFunc","flatMap",0xffbcb5fb,"tink.core._Lazy.LazyFunc.flatMap","tink/core/Lazy.hx",67,0x92445137)
namespace tink{
namespace core{
namespace _Lazy{

void LazyFunc_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_51_new)
HXDLIN(  51)		this->f = f;
            	}
...
static ::tink::core::_Lazy::LazyObject_obj _hx_tink_core__Lazy_LazyFunc__hx_tink_core__Lazy_LazyObject= {
	...
	( ::Dynamic (hx::Object::*)( ::Dynamic))&::tink::core::_Lazy::LazyFunc_obj::flatMap,
};
...
void *LazyFunc_obj::_hx_getInterface(int inHash) {
 ...
 ::Dynamic LazyFunc_obj::get(){
            	HX_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_53_get)
HXLINE(  55)		if (hx::IsNotNull( this->f )) {
HXLINE(  57)			this->result = this->f();
HXLINE(  58)			this->f = null();
            		}
HXLINE(  61)		return this->result;
            	}
...
::Dynamic LazyFunc_obj::map( ::Dynamic f){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::tink::core::_Lazy::LazyFunc,_gthis, ::Dynamic,f) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_65_map)
HXLINE(  65)			 ::Dynamic _hx_tmp = _gthis->get();
HXDLIN(  65)			return f(_hx_tmp);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_64_map)
HXDLIN(  64)		 ::tink::core::_Lazy::LazyFunc _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE(  65)		return  ::tink::core::_Lazy::LazyFunc_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(_gthis,f)));
            	}


HX_DEFINE_DYNAMIC_FUNC1(LazyFunc_obj,map,return )

::Dynamic LazyFunc_obj::flatMap( ::Dynamic f){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::tink::core::_Lazy::LazyFunc,_gthis, ::Dynamic,f) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_68_flatMap)
HXLINE(  68)			 ::Dynamic this1 = _gthis->get();
HXDLIN(  68)			return ::tink::core::_Lazy::LazyObject_obj::get(f(this1));
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_abecf4c8a88f2d81_67_flatMap)
HXDLIN(  67)		 ::tink::core::_Lazy::LazyFunc _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE(  68)		return  ::tink::core::_Lazy::LazyFunc_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(_gthis,f)));
            	}


HX_DEFINE_DYNAMIC_FUNC1(LazyFunc_obj,flatMap,return )
