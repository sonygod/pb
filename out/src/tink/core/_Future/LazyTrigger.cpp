...
HX_DEFINE_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_398_new,"tink.core._Future.LazyTrigger","new",0x4fa10477,"tink.core._Future.LazyTrigger.new","tink/core/Future.hx",398,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_406_eager,"tink.core._Future.LazyTrigger","eager",0x0bf8718f,"tink.core._Future.LazyTrigger.eager","tink/core/Future.hx",406,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_415_map,"tink.core._Future.LazyTrigger","map",0x4fa03eb3,"tink.core._Future.LazyTrigger.map","tink/core/Future.hx",415,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_419_map,"tink.core._Future.LazyTrigger","map",0x4fa03eb3,"tink.core._Future.LazyTrigger.map","tink/core/Future.hx",419,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_422_flatMap,"tink.core._Future.LazyTrigger","flatMap",0x750c9bfa,"tink.core._Future.LazyTrigger.flatMap","tink/core/Future.hx",422,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_426_flatMap,"tink.core._Future.LazyTrigger","flatMap",0x750c9bfa,"tink.core._Future.LazyTrigger.flatMap","tink/core/Future.hx",426,0x014a8a08)
HX_LOCAL_STACK_FRAME(_hx_pos_4fc97abdb2a2b8c1_429_handle,"tink.core._Future.LazyTrigger","handle",0xa51cb7f1,"tink.core._Future.LazyTrigger.handle","tink/core/Future.hx",429,0x014a8a08)
namespace tink{
namespace core{
namespace _Future{

void LazyTrigger_obj::__construct( ::Dynamic op){
            	HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_398_new)
HXLINE( 402)		this->op = op;
...
bool LazyTrigger_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::tink::core::FutureTrigger LazyTrigger_obj::eager(){
            	HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_406_eager)
HXLINE( 407)		if (hx::IsNotNull( this->op )) {
HXLINE( 408)			 ::Dynamic op = this->op;
HXLINE( 409)			this->op = null();
HXLINE( 410)			::tink::core::_Callback::Callback_Impl__obj::invoke(op,this->trigger_dyn());
            		}
...
::Dynamic LazyTrigger_obj::map( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_415_map)
HXDLIN( 415)		 ::tink::core::_Future::LazyTrigger _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 417)		if (hx::IsNull( this->op )) {
HXLINE( 417)			return this->super::map(f);
            		}
            		else {
            			...
            			void _hx_run( ::Dynamic cb){
            				...
            				void _hx_run( ::Dynamic v){
            					HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_419_map)
HXLINE( 419)					 ::Dynamic _hx_tmp = f(v);
HXDLIN( 419)					cb(_hx_tmp);
            				}
            				HX_END_LOCAL_FUNC1((void))

            				HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_419_map)
HXLINE( 419)				_gthis->handle( ::Dynamic(new _hx_Closure_0(f,cb)));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 418)			return ::tink::core::_Future::Future_Impl__obj::async( ::Dynamic(new _hx_Closure_1(_gthis,f)),true);
            		}
...
::Dynamic LazyTrigger_obj::flatMap( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_422_flatMap)
HXDLIN( 422)		 ::tink::core::_Future::LazyTrigger _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 424)		if (hx::IsNull( this->op )) {
HXLINE( 424)			return this->super::flatMap(f);
            		}
            		else {
            			HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::tink::core::_Future::LazyTrigger,_gthis, ::Dynamic,f) HXARGC(1)
            			void _hx_run( ::Dynamic cb){
            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f, ::Dynamic,cb) HXARGC(1)
            				void _hx_run( ::Dynamic v){
            					HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_426_flatMap)
HXLINE( 426)					::tink::core::_Future::FutureObject_obj::handle(f(v),cb);
            				}
            				HX_END_LOCAL_FUNC1((void))

            				HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_426_flatMap)
HXLINE( 426)				_gthis->handle( ::Dynamic(new _hx_Closure_0(f,cb)));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 425)			return ::tink::core::_Future::Future_Impl__obj::async( ::Dynamic(new _hx_Closure_1(_gthis,f)),true);
            		}
...
::Dynamic LazyTrigger_obj::handle( ::Dynamic cb){
            	HX_STACKFRAME(&_hx_pos_4fc97abdb2a2b8c1_429_handle)
HXLINE( 430)		this->eager();
HXLINE( 431)		return this->super::handle(cb);
            	}
