...
HX_DEFINE_STACK_FRAME(_hx_pos_a507cc4491813d5d_74_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",74,0xfc3a7709)
HX_DEFINE_STACK_FRAME(_hx_pos_a507cc4491813d5d_60_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",60,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_107_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",107,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_128___default_run,"haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",128,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_141_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",141,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_139_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",139,0xfc3a7709)
namespace haxe{
...
void Timer_obj::__construct(int time_ms){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_74_new)
...
HXLINE(  76)			_gthis->run();
            	...
            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_60_new)
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_107_stop)
...
void _hx_run(){
            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_128___default_run)
            	}
HX_END_LOCAL_FUNC0((void))
HX_END_DEFAULT_FUNC
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,int time_ms){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_a507cc4491813d5d_141_delay)
HXLINE( 142)			t->stop();
HXLINE( 143)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_a507cc4491813d5d_139_delay)
