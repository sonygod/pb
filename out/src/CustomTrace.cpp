...
HX_LOCAL_STACK_FRAME(_hx_pos_c6560b3dfbe614df_7_init,"CustomTrace","init",0x9573e8ca,"CustomTrace.init","KLSFGEN.hx",7,0x31644fc2)
HX_LOCAL_STACK_FRAME(_hx_pos_c6560b3dfbe614df_4_init,"CustomTrace","init",0x9573e8ca,"CustomTrace.init","KLSFGEN.hx",4,0x31644fc2)
...
void CustomTrace_obj::init(){
            		...
            		void _hx_run( ::Dynamic v, ::Dynamic pos){
            			HX_STACKFRAME(&_hx_pos_c6560b3dfbe614df_7_init)
HXLINE(   7)			::String _hx_tmp = ((HX_("[",5b,00,00,00) + ::Date_obj::now()->toString()) + HX_("] ",23,51,00,00));
HXDLIN(   7)			::String _hx_tmp1 = (_hx_tmp + ::Std_obj::string(v));
HXDLIN(   7)			oldTrace(_hx_tmp1,pos);
            		}
            		HX_END_LOCAL_FUNC2((void))

            	HX_STACKFRAME(&_hx_pos_c6560b3dfbe614df_4_init)
HXLINE(   5)		 ::Dynamic oldTrace = ::haxe::Log_obj::trace;
HXLINE(   6)		::haxe::Log_obj::trace =  ::Dynamic(new _hx_Closure_0(oldTrace));
            	}
