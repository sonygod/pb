...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9ad3d03d6728e6_203_open,"sys.db.Sqlite","open",0x1432cbdd,"sys.db.Sqlite.open","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",203,0xf219dfa9)
namespace sys{
namespace db{
...
::Dynamic Sqlite_obj::open(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_7b9ad3d03d6728e6_203_open)
HXDLIN( 203)		return  ::sys::db::_Sqlite::SqliteConnection_obj::__alloc( HX_CTX ,file);
            	}
