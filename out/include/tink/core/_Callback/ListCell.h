...
class HXCPP_CLASS_ATTRIBUTES ListCell_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7ee9d267 };

		void __construct( ::Dynamic cb,::Array< ::Dynamic> list);
		...
		static hx::ObjectPtr< ListCell_obj > __new( ::Dynamic cb,::Array< ::Dynamic> list);
		static hx::ObjectPtr< ListCell_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic cb,::Array< ::Dynamic> list);
