...
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_29_downcast,"Std","downcast",0x4619c56c,"Std.downcast","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",29,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_34_instance,"Std","instance",0x1431f4e0,"Std.instance","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",34,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_38_string,"Std","string",0xcf48855c,"Std.string","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",38,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_42_int,"Std","int",0x8fa53b84,"Std.int","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",42,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_46_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",46,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_50_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",50,0x6cd09c81)
HX_LOCAL_STACK_FRAME(_hx_pos_986723450deb4491_53_random,"Std","random",0x75a77e8e,"Std.random","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",53,0x6cd09c81)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::downcast( ::Dynamic value,hx::Class c){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_29_downcast)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,downcast,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_34_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_38_string)
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_42_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_46_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_50_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_986723450deb4491_53_random)
HXLINE(  54)		if ((x <= 0)) {
HXLINE(  55)			return 0;
            		}
