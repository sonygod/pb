...
HX_LOCAL_STACK_FRAME(_hx_pos_81c4e1302c9e66b9_17_init,"CustomTrace","init",0x9573e8ca,"CustomTrace.init","TestSqlite.hx",17,0x10c96ea0)
HX_LOCAL_STACK_FRAME(_hx_pos_81c4e1302c9e66b9_14_init,"CustomTrace","init",0x9573e8ca,"CustomTrace.init","TestSqlite.hx",14,0x10c96ea0)
...
void CustomTrace_obj::init(){
            		...
            		void _hx_run( ::Dynamic v, ::Dynamic pos){
            			HX_STACKFRAME(&_hx_pos_81c4e1302c9e66b9_17_init)
HXLINE(  17)			::String _hx_tmp = ((HX_("[",5b,00,00,00) + ::Date_obj::now()->toString()) + HX_("] ",23,51,00,00));
HXDLIN(  17)			::String _hx_tmp1 = (_hx_tmp + ::Std_obj::string(v));
HXDLIN(  17)			oldTrace(_hx_tmp1,pos);
            		}
            		HX_END_LOCAL_FUNC2((void))

            	HX_STACKFRAME(&_hx_pos_81c4e1302c9e66b9_14_init)
HXLINE(  15)		 ::Dynamic oldTrace = ::haxe::Log_obj::trace;
HXLINE(  16)		::haxe::Log_obj::trace =  ::Dynamic(new _hx_Closure_0(oldTrace));
            	}
