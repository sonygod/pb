...
HX_LOCAL_STACK_FRAME(_hx_pos_918b0b618e56d434_48_quote,"sys.db._Sqlite.SqliteConnection","quote",0x839e56ca,"sys.db._Sqlite.SqliteConnection.quote","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",48,0xf219dfa9)
namespace sys{
namespace db{
namespace _Sqlite{
...
::String SqliteConnection_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_918b0b618e56d434_48_quote)
