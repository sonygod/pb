...
HX_DECLARE_STACK_FRAME(_hx_pos_6b3fe25948ba01a2_5_new)
...
class HXCPP_CLASS_ATTRIBUTES MainEvent_obj : public hx::Object
{
	...
	public:
		...
		inline static hx::ObjectPtr< MainEvent_obj > __new( ::Dynamic f,int p) {
			hx::ObjectPtr< MainEvent_obj > __this = new MainEvent_obj();
			__this->__construct(f,p);
			return __this;
		}

		inline static hx::ObjectPtr< MainEvent_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic f,int p) {
...
HXLINE(  13)		( ( ::haxe::MainEvent)(__this) )->isBlocking = true;
HXLINE(  19)		( ( ::haxe::MainEvent)(__this) )->f = f;
HXLINE(  20)		( ( ::haxe::MainEvent)(__this) )->priority = p;
HXLINE(  21)		( ( ::haxe::MainEvent)(__this) )->nextRun = ( (Float)(-1) );
            	}
